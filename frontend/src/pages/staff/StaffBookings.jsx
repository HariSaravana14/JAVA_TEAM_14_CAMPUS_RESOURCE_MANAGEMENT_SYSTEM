				...
				<div style={{ flex: 1 }} className="stack">
					<div className="card">
						...
						<div style={{ marginTop: 8, fontSize: 13, color: '#374151' }}>
							View and track your own resource booking requests
						</div>
					</div>
					...
					<div className="card">
						...
						<div className="row" style={{ gap: 12 }}>
							...
							<div style={{ 
								...
								<div style={{ fontSize: 22, fontWeight: 700, color: '#1d4ed8' }}>{stats.pending}</div>
								<div style={{ fontSize: 11, color: '#1d4ed8' }}>Pending Admin</div>
							</div>
							<div style={{ 
								flex: 1, 
								padding: 14, 
					...
					<div className="card" style={{ background: '#eff6ff', borderColor: '#bfdbfe' }}>
						<div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
							...
							<div style={{ fontSize: 13, color: '#1e40af' }}>
								As a staff member, your bookings go directly to Admin for approval (skipping staff review).
							</div>
						</div>
					</div>
